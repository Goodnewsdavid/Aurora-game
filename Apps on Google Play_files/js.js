...
(function() {
    ...
    var data = {
        "resource": {
            ...
            "tags": [{
                ...
                "priority": 11,
                "vtp_instanceDestinationId": "G-LLFP66ELGJ",
                "tag_id": 29
            }, {
    ...
    */
    ...
    ni.oe = Number("0") || 0;
    ni.ia = "dataLayer";
    ni.gk = "ChEIgMnlqwYQ9pPxrcG3gc/PARIlAMkfU+qqij955xH0hM6QIYV8ilyPL7z1j2EJ4NC6EmDZlguZnxoChSc\x3d";
    var qi = {
            __cl: 1,
            __ecl: 1,
            __ehl: 1,
    ...
    var lj;
    try {
        lj = JSON.parse(yb("eyIwIjoiU0ciLCIxIjoiIiwiMiI6ZmFsc2UsIjMiOiJnb29nbGUuY29tLnNnIiwiNCI6IiIsIjUiOnRydWUsIjYiOmZhbHNlLCI3IjoiYWRfc3RvcmFnZXxhbmFseXRpY3Nfc3RvcmFnZXxhZF91c2VyX2RhdGF8YWRfcGVyc29uYWxpemF0aW9uIn0"))
    } catch (a) {
        O(123), kj(2), lj = {}
    }
    var mj = function() {
    ...
    var wC = function(a, b, c) {
        ...
        CC = function(a, b) {
            ...
            if (EC(c, "embed/")) {
                ...
                if (b) {
                    var d;
                    var e = -1 !== c.indexOf("?") ? "&" : "?"; - 1 < c.indexOf("origin=") ? d = c + e + "enablejsapi=1" : (uC || (uC = E.location.protocol + "//" + E.location.hostname, E.location.port && (uC += ":" + E.location.port)), d = c + e + "enablejsapi=1&origin=" + encodeURIComponent(uC));
                    var f;
                    f = Kb(d);
                    a.src = Ib(f).toString();
                    return !0
    ...
    function kE() {
        var a = new sb;
        M(this, "read_container_data"), a.set("containerId", 'G-LLFP66ELGJ'), a.set("version", '1'), a.set("environmentName", ''), a.set("debugMode", $f), a.set("previewMode", bg), a.set("environmentMode", ag), a.set("firstPartyServing", wi || yi), a.set("containerUrl", Ec), a.Cb();
        return a
    }
        ...
        try {
            ...
            if (void 0 !== W(a.s, Q.g.Vc)) a.copyToHitData(Q.g.Vc);
                ...
                if (!($m = dj)) {
                    var fj;
                    if (fj = gw) a: {
                        for (var iw = gw.include_conditions || [], pI = Fn(Hn(a.h[Q.g.Ma]), "host", !0), bn = 0; bn < iw.length; bn++)
                            if (iw[bn].test(pI)) {
                                fj = !0;
                                break a
                            }
